...
calculateYears1 = (principal, interest, tax, desired) => {
    let years = 0;
...
calculateYears2 = (principal, interest, tax, desired) => {
    return Math.ceil(Math.log(desired / principal) / Math.log(1 + interest * (1 - tax)));
}

console.log(calculateYears1(1000, 0.05, 0.18, 1100)); // 3
console.log(calculateYears1(1000, 0.01625, 0.18, 1200)); // 14
console.log(calculateYears1(1000, 0.05, 0.18, 1000)); // 0

console.log(calculateYears2(1000, 0.05, 0.18, 1100)); // 3
console.log(calculateYears2(1000, 0.01625, 0.18, 1200)); // 14
console.log(calculateYears2(1000, 0.05, 0.18, 1000)); // 0